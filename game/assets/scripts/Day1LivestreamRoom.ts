...
type PlayerStatus = 'nobody' | 'familiar_face' | 'room_regular' | 'contender' | 'top_supporter' | 'room_core';
type RoomMood = 'cold' | 'curious' | 'lively' | 'tense' | 'chaotic' | 'loyal';

type GameState = {
  playerStatus: PlayerStatus;
  streamerAttention: number;
  chatRecognition: number;
  oldFanJealousy: number;
  haterHeat: number;
  moderatorTrust: number;
  styleHumble: number;
  styleDominant: number;
  styleChaos: number;
  roomMood: RoomMood;
  finalTitle: string;
...
const EVENTS: Record<string, EventNode> = {
  E00: {
    ...
    chatLines: [
      'oldfan_77：MoonlitBoss今天还没来？',
      'hater_404：主播今天又在装正经',
      'tea_fan_12：Nana刚刚那句可以剪',
      'Qing[房管]：新观众先看置顶规则',
      'sleepy_cat：今晚好安静'
    ],
    choices: [
      {
        ...
        chatLines: [
          'system：你进入了直播间。',
          'oldfan_77：新观众？',
          'hater_404：又来一个想被念名字的。',
          'Qing[房管]：新观众先看置顶规则。',
          'sleepy_cat：今晚人慢慢多了。'
        ],
        stateChanges: [{ key: 'currentNodeId', value: 'E01' }],
        nextNodeId: 'E01'
      }
    ]
  },
    ...
    choices: [
      {
        ...
        stateChanges: [
          { key: 'chatRecognition', delta: 5 },
          { key: 'currentNodeId', value: 'E02' }
        ],
        nextNodeId: 'E02'
      },
      {
    ...
    choices: [
      {
        ...
        stateChanges: [
          { key: 'playerStatus', value: 'familiar_face' },
          { key: 'streamerAttention', delta: 15 },
          { key: 'chatRecognition', delta: 15 },
          { key: 'currentNodeId', value: 'E03' }
        ],
        nextNodeId: 'E03'
      },
      {
        ...
        stateChanges: [
          { key: 'playerStatus', value: 'familiar_face' },
          { key: 'streamerAttention', delta: 20 },
          { key: 'chatRecognition', delta: 20 },
          { key: 'currentNodeId', value: 'E03' }
        ],
        nextNodeId: 'E03'
      },
      {
        ...
        stateChanges: [
          { key: 'playerStatus', value: 'familiar_face' },
          { key: 'streamerAttention', delta: 18 },
          { key: 'chatRecognition', delta: 18 },
          { key: 'oldFanJealousy', delta: 5 },
          { key: 'currentNodeId', value: 'E03' }
        ],
        nextNodeId: 'E03'
      }
    ...
    choices: [
      {
        ...
        stateChanges: [
          { key: 'playerStatus', value: 'room_regular' },
          { key: 'oldFanJealousy', delta: 10 },
          { key: 'roomMood', value: 'curious' },
          { key: 'currentNodeId', value: 'E04' }
        ],
        nextNodeId: 'E04'
      },
      {
        ...
        chatLines: [
          '你：使用话题券',
          'tea_fan_12：让新人做饭。',
          'oldfan_77：以前话题都是大家投票。',
          'hater_404：民主死于一张券。',
          'Qing[房管]：只许一个话题。'
        ],
        stateChanges: [
          { key: 'playerStatus', value: 'room_regular' },
          { key: 'oldFanJealousy', delta: 15 },
          { key: 'roomMood', value: 'curious' },
          { key: 'currentNodeId', value: 'E04' }
        ],
        nextNodeId: 'E04'
    ...
    choices: [
      {
        ...
        stateChanges: [
          { key: 'chatRecognition', delta: 10 },
          { key: 'haterHeat', delta: -5 },
          { key: 'roomMood', value: 'lively' },
          { key: 'currentNodeId', value: 'E05' }
        ],
        nextNodeId: 'E05'
      },
      {
        ...
        chatLines: [
          '你：排一下粉丝混乱度',
          'tea_fan_12：做！',
          'oldfan_77：这就是新人不该有按钮的原因。',
          'hater_404：直播间内战启动。',
          'Qing[房管]：我不参与。'
        ],
        stateChanges: [
          { key: 'chatRecognition', delta: 15 },
          { key: 'haterHeat', delta: 10 },
          { key: 'roomMood', value: 'lively' },
          { key: 'currentNodeId', value: 'E05' }
        ],
        nextNodeId: 'E05'
      },
      {
        ...
        stateChanges: [
          { key: 'chatRecognition', delta: 12 },
          { key: 'haterHeat', delta: 8 },
          { key: 'roomMood', value: 'lively' },
          { key: 'currentNodeId', value: 'E05' }
        ],
        nextNodeId: 'E05'
    ...
    choices: [
      {
        ...
        chatLines: [
          ...
          'tea_fan_12：态度还可以。',
          'oldfan_77：至少没摆架子。',
          'hater_404：温和路线？无聊但有效。',
          'Qing[房管]：这样说可以。'
        ],
        stateChanges: [
          { key: 'moderatorTrust', delta: 10 },
          { key: 'haterHeat', delta: -5 },
          { key: 'styleHumble', delta: 1 },
          { key: 'roomMood', value: 'tense' },
          { key: 'currentNodeId', value: 'E06' }
        ],
        nextNodeId: 'E06'
      },
      {
        ...
        stateChanges: [
          { key: 'chatRecognition', delta: 15 },
          { key: 'oldFanJealousy', delta: 20 },
          { key: 'haterHeat', delta: 15 },
          { key: 'styleDominant', delta: 1 },
          { key: 'roomMood', value: 'tense' },
          { key: 'currentNodeId', value: 'E06' }
        ],
        nextNodeId: 'E06'
  ...
  E06: {
    ...
    chatLines: [
      'system：MoonlitBoss 进入直播间。',
      'oldfan_77：真正的榜一来了。',
      'tea_fan_12：新老板对老老板？',
      'hater_404：今晚有正片。',
      'MoonlitBoss：房间很热闹。新来的老板是谁？'
    ],
    powerTopicUnlocked: true,
    choices: [
      {
      ...
      },
      {
        ...
        chatLines: [
          ...
          'oldfan_77：他在借主播抬自己。',
          'hater_404：这球传得脏。',
          'Qing[房管]：别拿 Nana 当挡箭牌。'
        ],
        stateChanges: [
          { key: 'streamerAttention', delta: 15 },
          { key: 'haterHeat', delta: 10 },
          { key: 'styleChaos', delta: 1 },
          { key: 'currentNodeId', value: 'E07' }
        ],
        nextNodeId: 'E07'
      }
    ...
    choices: [
      {
        ...
        stateChanges: [
          { key: 'playerStatus', value: 'contender' },
          { key: 'chatRecognition', delta: 25 },
          { key: 'streamerAttention', delta: 15 },
          { key: 'oldFanJealousy', delta: 15 },
          { key: 'currentNodeId', value: 'E08' }
        ],
        nextNodeId: 'E08'
      },
      {
        ...
        stateChanges: [
          { key: 'playerStatus', value: 'contender' },
          { key: 'chatRecognition', delta: 22 },
          { key: 'streamerAttention', delta: 12 },
          { key: 'moderatorTrust', delta: 8 },
          { key: 'styleChaos', delta: 1 },
          { key: 'currentNodeId', value: 'E08' }
        ],
        nextNodeId: 'E08'
      },
      {
        ...
        stateChanges: [
          { key: 'playerStatus', value: 'contender' },
          { key: 'chatRecognition', delta: 18 },
          { key: 'streamerAttention', delta: 14 },
          { key: 'moderatorTrust', delta: 8 },
          { key: 'styleHumble', delta: 1 },
          { key: 'currentNodeId', value: 'E08' }
        ],
    ...
    choices: [
      {
        ...
        chatLines: [
          ...
          'hater_404：Qing 加班宇宙。',
          'Qing[房管]：我没有同意。',
          'system：Clip: Qing加班奶茶月亮'
        ],
        stateChanges: [
          { key: 'haterHeat', delta: 10 },
          { key: 'roomMood', value: 'chaotic' },
          { key: 'styleChaos', delta: 1 },
          { key: 'currentNodeId', value: 'E09' }
        ],
        nextNodeId: 'E09'
      },
      {
    ...
    choices: [
      {
        ...
        chatLines: [
          ...
          'oldfan_77：果然还是砸礼物。',
          'hater_404：金光压场。',
          'system：Day 3 到达榜一转换前。'
        ],
        stateChanges: [
          { key: 'playerStatus', value: 'top_supporter' },
          { key: 'roomMood', value: 'loyal' },
          { key: 'streamerAttention', delta: 25 },
          { key: 'chatRecognition', delta: 20 },
          { key: 'oldFanJealousy', delta: 20 },
          { key: 'styleDominant', delta: 1 },
          { key: 'currentNodeId', value: 'E10' }
        ],
        nextNodeId: 'E10'
      },
      {
      ...
      },
      {
        ...
        stateChanges: [
          { key: 'playerStatus', value: 'top_supporter' },
          { key: 'roomMood', value: 'loyal' },
          { key: 'moderatorTrust', delta: 20 },
          { key: 'haterHeat', delta: -20 },
          { key: 'streamerAttention', delta: 15 },
          { key: 'chatRecognition', delta: 20 },
          { key: 'styleHumble', delta: 1 },
          { key: 'currentNodeId', value: 'E10' }
    ...
    choices: [
      {
        ...
        stateChanges: [
          { key: 'streamerAttention', delta: 10 },
          { key: 'haterHeat', delta: 8 },
          { key: 'styleDominant', delta: 1 },
          { key: 'currentNodeId', value: 'E12' }
        ],
        nextNodeId: 'E12'
      },
      {
    ...
    choices: [
      {
        ...
        stateChanges: [
          { key: 'finalTitle', value: '新老板时代' },
          { key: 'playerStatus', value: 'room_core' },
          { key: 'chatRecognition', value: 100 },
          { key: 'roomMood', value: 'chaotic' },
          { key: 'styleDominant', delta: 1 },
          { key: 'currentNodeId', value: 'E13' }
        ],
        nextNodeId: 'E13'
      },
      {
        ...
        stateChanges: [
          { key: 'finalTitle', value: 'Nana假装不在乎' },
          { key: 'playerStatus', value: 'room_core' },
          { key: 'chatRecognition', value: 100 },
          { key: 'roomMood', value: 'chaotic' },
          { key: 'styleHumble', delta: 1 },
    ...
    choices: [
      {
        ...
        stateChanges: [{ key: 'currentNodeId', value: 'E14' }],
        nextNodeId: 'E14'
      }
    ]
  },
    ...
    choices: [
      {
        ...
        stateChanges: [
          { key: 'playerStatus', value: 'nobody' },
          { key: 'streamerAttention', value: 0 },
          { key: 'chatRecognition', value: 0 },
          { key: 'oldFanJealousy', value: 0 },
          { key: 'haterHeat', value: 0 },
          { key: 'moderatorTrust', value: 0 },
          { key: 'styleHumble', value: 0 },
          { key: 'styleDominant', value: 0 },
          { key: 'styleChaos', value: 0 },
          { key: 'roomMood', value: 'cold' },
          { key: 'finalTitle', value: 'Nana的深夜闲聊' },
          { key: 'currentNodeId', value: 'E00' }
        ],
        nextNodeId: 'E00'
      }
    ]
...
@ccclass('Day1LivestreamRoom')
export class Day1LivestreamRoom extends Component {
  private readonly width = 750;
  private readonly height = 1334;
  private root: Node | null = null;
  private state: GameState = this.createInitialState();
  private overrideNanaLine: string | null = null;
  private overrideChatLines: string[] | null = null;
  ...
  private get currentEvent(): EventNode {
    return EVENTS[this.state.currentNodeId] ?? EVENTS.E00;
  }

  private resetCanvas() {
    const hostNode = this.getRenderHostNode();
    const transform = hostNode.getComponent(UITransform) ?? hostNode.addComponent(UITransform);
  ...
  private getRenderHostNode() {
    const runtimeNode = this.node as RuntimeNode;
  ...
  private buildStreamerStage() {
    ...
    this.createLabel(
      bubble,
      'NanaLineLabel',
      this.overrideNanaLine ?? event.nanaLine,
      0,
      0,
      22,
      new Color(243, 239, 249, 255),
      480
    );
  }
  ...
  private buildChoicePanel() {
    ...
    for (let index = 0; index < 3; index += 1) {
      ...
      this.createButton(
        ...
        46,
        Boolean(choice),
        choice ? () => this.selectChoice(choice) : undefined
      );
    }
  }
  ...
  private applyStateChange(change: StateChange) {
  ...
  private setStateValue(key: keyof GameState, value: string | number) {
    switch (key) {
      case 'playerStatus':
        this.state.playerStatus = value as PlayerStatus;
        break;
      case 'streamerAttention':
        this.state.streamerAttention = value as number;
        break;
      case 'chatRecognition':
        this.state.chatRecognition = value as number;
        break;
      case 'oldFanJealousy':
        this.state.oldFanJealousy = value as number;
        break;
      case 'haterHeat':
        this.state.haterHeat = value as number;
        break;
      case 'moderatorTrust':
        this.state.moderatorTrust = value as number;
        break;
      case 'styleHumble':
        this.state.styleHumble = value as number;
        break;
      case 'styleDominant':
        this.state.styleDominant = value as number;
        break;
      case 'styleChaos':
        this.state.styleChaos = value as number;
        break;
      case 'roomMood':
        this.state.roomMood = value as RoomMood;
        break;
      case 'finalTitle':
        this.state.finalTitle = value as string;
        break;
      case 'currentNodeId':
        this.state.currentNodeId = value as string;
        break;
    }
  }

  private getPlayerRankLabel() {
  ...
  private getRoomTitle(event: EventNode) {
  ...
  private getChatLines(event: EventNode) {
    ...
    if (event.id === 'E15') {
      return [
        'system：15分钟切片完成。',
        `system：身份 ${PLAYER_STATUS_LABELS[this.state.playerStatus]} / 标题「${this.state.finalTitle}」`,
        `system：影响 ${this.state.chatRecognition} / Qing信任 ${this.state.moderatorTrust}`,
        `system：嫉妒 ${this.state.oldFanJealousy} / 黑粉热度 ${this.state.haterHeat}`,
        `system：结算路线：${this.getEndingStyleLabel()}`
      ];
    }
  ...
  private getChatLineColor(text: string) {
  ...
  private createButton(parent: Node, name: string, text: string, x: number, y: number, w: number, h: number, enabled: boolean, onClick?: () => void) {
  ...
  private createRectNode(name: string, x: number, y: number, w: number, h: number, style: RectStyle, parent: Node = this.root ?? this.node) {
  ...
  private syncLayer(node: Node, parent: Node) {
    const parentLayer = (parent as RuntimeNode).layer;
    if (parentLayer !== undefined) {
      (node as RuntimeNode).layer = parentLayer;
    }
  }
}
