    ...
    execute: function () {
      ...
      _export("Day1LivestreamRoom", Day1LivestreamRoom = (_dec = ccclass('Day1LivestreamRoom'), _dec(_class = class Day1LivestreamRoom extends Component {
        ...
        resetCanvas() {
          ...
          var hostNode = this.getRenderHostNode();
          var transform = (_hostNode$getComponen = hostNode.getComponent(UITransform)) != null ? _hostNode$getComponen : hostNode.addComponent(UITransform);
          transform.setContentSize(new Size(this.width, this.height));
          var existingRoot = hostNode.getChildByName('Day1Root');
          ...
          var rootTransform = this.root.addComponent(UITransform);
          rootTransform.setContentSize(new Size(this.width, this.height));
        }

        getRenderHostNode() {
          var runtimeNode = this.node;
        ...
        buildTopBar() {
          ...
          var topBar = this.createRectNode('TopBar', 0, y, 726, 76, {
        ...
        buildSupporterStrip() {
          var y = 544;
          var strip = this.createRectNode('SupporterStrip', 0, y, 726, 88, {
          ...
          var playerRank = this.state.playerStatus === 'nobody' ? '你：未上榜' : "\u4F60\uFF1A" + this.getPlayerRankLabel();
        ...
        buildStreamerStage() {
          ...
          var y = 260;
          var event = this.currentEvent;
          var stage = this.createRectNode('StreamerStage', 0, y, 726, 456, {
          ...
          var bubble = this.createRectNode('NanaLineBubble', 78, -138, 520, 104, {
        ...
        buildPlayerStatus() {
          var y = -4;
          var row = this.createRectNode('PlayerStatusRow', 0, y, 726, 82, {
        ...
        buildChatPanel() {
          var y = -220;
          var event = this.currentEvent;
          var panel = this.createRectNode('ChatPanel', 0, y, 726, 310, {
          ...
          var lines = this.getChatLines(event);
        ...
        buildPowerRow() {
          var y = -424;
          var topicUnlocked = this.currentEvent.powerTopicUnlocked === true;
          var row = this.createRectNode('PowerRow', 0, y, 726, 84, {
        ...
        buildChoicePanel() {
          ...
          var panel = this.createRectNode('ChoicePanel', 0, y, 726, 200, {
            fill: new Color(28, 31, 42, 255),
            stroke: new Color(76, 84, 112, 255)
          });
          var positions = [58, 0, -58];

          var _loop = function _loop() {
            var choice = choices[index];

            _this.createButton(panel, "ChoiceButton" + (index + 1), choice ? choice.label : '', 0, positions[index], 660, 46, Boolean(choice), choice ? () => _this.selectChoice(choice) : undefined);
          };
        ...
        selectChoice(choice) {
          ...
          for (var change of choice.stateChanges) {
        ...
        applyStateChange(change) {
          ...
          if (change.delta !== undefined) {
            var current = this.state[change.key];
        ...
        createButton(parent, name, text, x, y, w, h, enabled, onClick) {
          var buttonNode = this.createRectNode(name, x, y, w, h, {
        ...
        createRectNode(name, x, y, w, h, style, parent) {
          if (parent === void 0) {
            var _this$root;

            parent = (_this$root = this.root) != null ? _this$root : this.node;
          }
