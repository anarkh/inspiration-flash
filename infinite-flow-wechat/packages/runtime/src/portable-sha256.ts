...
/** Portable, dependency-free SHA-256 used when a platform hash adapter is absent. */
export function sha256(bytes: Uint8Array): Uint8Array {
  ...
  const bitLengthHigh = Math.floor(bytes.length / 0x2000_0000);
...
export class PortableSha256HashPort implements HashPort {
